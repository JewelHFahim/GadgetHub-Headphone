    ...
    return (
        <div className='px-[20px] lg:px-[16vw] pt-[30px] pb-[20px] lg:mt-[75px]'>
            ...
            <div className='flex justify-between items-start lg:items-center'>
                ...
                <div>
                    <SubTitle className={`text-[40px] lg:text-[60px] ${isDarkmode ? "text-white" : "text-bgPrimary"}`}>OUR</SubTitle>

                    <PrimaryTitle className={`text-[50px] lg:text-[120px] font-poppins leading-[40px] lg:leading-[100px] ml-[-4px] ${isDarkmode ? "stroke-white" : " stroke-black"}`}> Feature </PrimaryTitle>
                </div>
            ...
            <div className='hidden mt-[12px] lg:grid grid-cols-1 lg:grid-cols-3'>
                {
                    datas.map((item, index) => (
                        <div key={index} className={`w-[21.5vw] h-[100%] border border-opacity-[60%] p-[8%] ${isDarkmode ? "border-white" : "border-black"} transform duration-300 hover:scale-[1.03]`}
